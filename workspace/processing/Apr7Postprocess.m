...
main_directory='/Users/katie/Desktop/ModelingSeawater/workspace/disc268_1600/profile5.21.mat';     %Enter location of output files
...
test='5';                                                                   %Enter test number string (after T)
type='Het';                                                                 %Enter 'Hom' or 'Het'
set_num=21;                                                                  %Enter connectivity case number
low=1;                                                                     %Enter lowest run number in series
high=1;                                                                    %Enter highest run number in series

x_cells=1;                                                                  %Enter number of cells in the x direction (parallel to coastline) of geostat simulation
y_cells=1600;                                                                %Enter number of cells in the y direction (perpendicular to coastline) for geostat simulation
z_cells=268;                                                                %Enter number of cells in the z direction (depth) for geostat simulation
